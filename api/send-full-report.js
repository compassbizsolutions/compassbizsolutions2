 ...
 *
 * The $599 Full DIY Package delivery function.
 *
 * Flow:
...
const DOC_FILES = [
  ...
  { name: "Template — Service Agreement & Maintenance Contract.docx", file: "CBS_Service_Agreement_Maintenance_Contract.docx" },
  { name: "Template — Change Order Template.docx",               file: "CBS_Change_Order_Template.docx" },
  { name: "Template — Referral & Review Request System.docx",    file: "CBS_Referral_Review_Request_System.docx" },
  { name: "Template — Pricing Worksheet & Rate Calculator.docx", file: "CBS_Pricing_Worksheet_Rate_Calculator.docx" },
];
...
For each priority, reference the EXACT guide or template from our product line that addresses it:

Fix-It Guides available: Guide #1: The Pricing Leak Fix (includes Pricing Worksheet & Rate Calculator template) · Guide #2: The Scheduling Black Hole (use with Appointment Confirmation Process template) · Guide #3: The Employee Cost Leak (use with Employee Handbook and New Hire Training templates) · Guide #4: The Recurring Revenue Gap (use with Service Agreement & Maintenance Contract template) · Guide #5: The Estimate-to-Invoice Leak (use with Change Order Template and Job Completion & Invoicing Process template) · Guide #6: The Cash Flow Blind Spot · Guide #7: The Customer Churn Leak (use with Customer Follow-Up Sequence and Referral & Review Request System templates) · Guide #8: The Materials Markup Fix (use with Parts & Supply Ordering Process and Truck Restocking Checklist templates) · Guide #9: The Admin Time Drain · Guide #10: The Vehicles & Parts Leak (use with Truck Restocking Checklist and Parts & Supply Ordering Process templates)

For each priority use this format:
PRIORITY [N]: [Action title]
WHY NOW: [One sentence — grounded in ${tradeType} business reality and their specific numbers]
HOW LONG: [Realistic time estimate]
START WITH: [Name the specific Fix-It Guide AND any template that directly supports this action]
ESTIMATED RECOVERY: $[dollar amount] once implemented

[QUICK_WINS]
3 things they can do this week at zero cost. For each, name the specific template or guide section that supports it. Specific to a ${tradeType} business. Numbered. No fluff.

[CLOSING]
2 sentences. What to do first (name the specific guide and template) and exactly why it matters for their specific ${tradeType} operation and their leak number.`;
}
...
${reportText}
        ...
        <div style="background: white; border-radius: 8px; padding: 20px 24px; margin-bottom: 20px; border: 1px solid #D8D4CD;">
          ...
          <div style="font-size: 12px; color: #6B7A90; line-height: 2;">
            <strong style="color: #3E4E63;">12 Process Doc Templates</strong><br>
            Truck Restocking · Appointment Confirmation · Employee Handbook · Job Completion & Invoicing · Customer Follow-Up · Parts Ordering · New Hire Training · Safety & Job Site · Service Agreement & Maintenance Contract · Change Order · Referral & Review Request System · Pricing Worksheet & Rate Calculator
          </div>
        </div>
