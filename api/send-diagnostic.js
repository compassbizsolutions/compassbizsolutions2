    ...
    function renderContent(text) {
      ...
      return text.split("\n")
        ...
        .map(function(line) {
          ...
          return isBullet
            ? '<div style="padding:5px 0 5px 18px;position:relative;font-size:15px;color:#1A2332;line-height:1.7">'
              + '<span style="position:absolute;left:0;top:7px;width:6px;height:6px;background:#C8701A;border-radius:50%;display:inline-block"></span>'
              + clean + '</div>'
