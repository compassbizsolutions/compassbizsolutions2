...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const html = `
      <div style="font-family:Arial,sans-serif;max-width:620px;margin:0 auto;color:#3E4E63;">
        <div style="background:#1B2E4B;padding:32px 36px;border-radius:8px 8px 0 0;">
          <div style="font-size:10px;color:rgba(255,255,255,0.35);letter-spacing:3px;margin-bottom:10px;">COMPASS BUSINESS SOLUTIONS â€” FREE DIAGNOSTIC</div>
          ...
          <div style="font-size:13px;color:rgba(255,255,255,0.45);margin-top:8px;">Prepared for ${firstName} â€” ${biz}</div>
        </div>
        <div style="background:#F7F5F2;padding:32px 36px;border-radius:0 0 8px 8px;border:1px solid #D8D4CD;">
          ...
          <p style="color:#3E4E63;line-height:1.7;margin-top:0;">Here is your free diagnostic for <strong>${biz}</strong>${trade ? " â€” " + trade : ""}.</p>
          ...
          <div style="margin:20px 0;">
            <div style="font-size:11px;font-weight:bold;color:#1A2332;letter-spacing:2px;margin-bottom:16px;">YOUR NEXT STEP â€” TWO OPTIONS:</div>
            ...
            <div style="background:white;border:1px solid #D8D4CD;border-top:3px solid #C8701A;border-radius:8px;padding:18px 20px;margin-bottom:12px;">
              ...
              <div style="font-size:12px;color:#3E4E63;line-height:1.75;margin-bottom:12px;">
                Tell us about your operation â€” we build a customized 30-day action plan targeting your specific leaks. Your plan, daily tasks, guides, and progress tracker all live in <strong>FixKit</strong>, your personal business portal. Log in from your phone, check off tasks as you go, and ask questions anytime.<br><br>
                No email chains. No PDFs to hunt through. Everything in one place.
              </div>
              <a href="https://www.compassbizsolutions.com/?buy=30day" style="display:inline-block;background:#C8701A;color:white;font-weight:bold;font-size:13px;padding:11px 24px;border-radius:8px;text-decoration:none;">Get My 30-Day Plan â€” $249 â†’</a>
            </div>
            ...
            <div style="background:white;border:1px solid #C8701A;border-top:3px solid #C8701A;border-radius:8px;padding:18px 20px;margin-bottom:12px;position:relative;">
              <div style="display:inline-block;background:#C8701A;color:white;font-size:9px;font-weight:bold;letter-spacing:1.5px;padding:2px 10px;border-radius:99px;margin-bottom:10px;">BEST VALUE â€” SAVES $147</div>
              <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:10px;">
                <div>
              ...
              <div style="font-size:12px;color:#3E4E63;line-height:1.75;margin-bottom:12px;">
                Everything in the 30-day plan, plus your full 60 and 90-day roadmap â€” all three phases customized to your business and loaded into FixKit from day one. Your biggest leaks first, next tier second, remaining third. One payment, all 90 days, saves $147.<br><br>
                Your portal, your plan, your progress. All in one place from start to finish.
              </div>
              <a href="https://www.compassbizsolutions.com/?buy=bundle" style="display:inline-block;background:#C8701A;color:white;font-weight:bold;font-size:13px;padding:11px 24px;border-radius:8px;text-decoration:none;">Get the Full 30/60/90 Bundle â€” $599 â†’</a>
            </div>
            ...
            <div style="background:#F7F5F2;border:1px solid #D8D4CD;border-radius:8px;padding:14px 18px;text-align:center;">
              ...
              <a href="https://www.compassbizsolutions.com/scoping-call" style="display:inline-block;background:#1B2E4B;color:white;font-weight:bold;font-size:12px;padding:9px 20px;border-radius:8px;text-decoration:none;">Book a Free Scoping Call â†’</a>
            </div>
          </div>
          <p style="font-size:13px;color:#6B7A90;margin-bottom:4px;">Questions? Reply to this email â€” I read every one.</p>
          <p style="margin:0;color:#3E4E63;font-size:13px;">â€” Jen, Compass Business Solutions</p>
        </div>
        <div style="text-align:center;padding:16px;font-size:11px;color:#A0ABBE;">
          Compass Business Solutions &nbsp;Â·&nbsp; compassbizsolutions.com
        </div>
      </div>`;
    ...
    await resend.emails.send({
      ...
      to: email,
      subject: "Your Free Business Diagnostic â€” " + (biz || "Your Business"),
      html
    });
    ...
    resend.emails.send({
      ...
      subject: "New Diagnostic â€” " + (biz || "Unknown") + " (" + (trade || "Unknown trade") + ") â€” " + phone,
