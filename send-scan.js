...
${teaser}
          ...
          <div style="background: white; border-left: 4px solid #C8701A; border-radius: 0 8px 8px 0; padding: 18px 20px; margin-bottom: 20px; border-top: 1px solid #D8D4CD; border-right: 1px solid #D8D4CD; border-bottom: 1px solid #D8D4CD;">
            ...
            <p style="margin: 0 0 12px; font-size: 13px; color: #3E4E63; line-height: 1.65;">This scan covers 5 of 10 leak categories. The <strong>Full DIY Package</strong> covers all 10 — leaks ranked by dollar amount, a customized prioritized to-do list, all 10 Fix-It Guides, and all 8 Process Doc templates.</p>
